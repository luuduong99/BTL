            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel-body" style="margin: 20px;">
                        <form action="{{ route('front.vnpay_payment') }}" method="POST">
                            ...
                            <button style="font-size: 16px;" class="btn btn-success" name="redirect">Thanh toán qua VNPAY</button>
                        </form>
                    </div>
                </div>
                <h1 style="text-align: center;">Đơn hàng - Thanh toán online</h1>
                <div class="">
